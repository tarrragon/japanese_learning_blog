---
title: けどの用法
description: けど/けれど/けれどもの用法 - 逆接・鋪陳・委婉等功能
type: concept
subtype: conjunction
jlpt: n4
stage: pending
...
flowchart TD
    ...
    C --> C1["雨だけど出かける<br/>（雖然下雨但出門）"]
    D --> D1["すみませんけど...<br/>（不好意思...）"]
    E --> E1["手伝ってほしいんですけど<br/>（想請你幫忙...）"]
    F --> F1["兄は医者だけど弟は弁護士<br/>（哥哥是醫生，弟弟是律師）"]
    G --> G1["用事があるんだけど...<br/>（有點事...）"]
