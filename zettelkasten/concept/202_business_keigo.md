...
```mermaid
flowchart TB
    subgraph L5["層級5：最高敬語"]
        L5a["VIP客戶<br/>重要典禮<br/>公式文件"]
        L5b["ご臨席賜る<br/>クッション言葉多用"]
    end

    subgraph L4["層級4：高敬語"]
        L4a["重要交易對象<br/>高階主管<br/>初次客戶"]
        L4b["ご〜いただける<br/>〜でしょうか"]
    end

    subgraph L3["層級3：標準敬語"]
        L3a["上司・前輩<br/>一般交易對象"]
        L3b["お〜になる<br/>お〜する"]
    end
    ...
    style L5 fill:#8B0000,color:white
    style L4 fill:#B22222,color:white
    style L3 fill:#CD5C5C,color:white
    style L2 fill:#F08080,color:white
    style L1 fill:#FFA07A,color:white
```
...
flowchart TD
    ...
    style K fill:#CD5C5C,color:white
    style F fill:#CD5C5C,color:white
    style L fill:#F08080,color:white
    style J fill:#FFA07A,color:white
```
