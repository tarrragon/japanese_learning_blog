...
```mermaid
flowchart TD
    A["辞書形<br/>書く<br/>(to write)"] --> B["ます形<br/>書きます<br/>(polite present)"]
    A --> C["て形<br/>書いて<br/>(connective)"]
    A --> D["た形<br/>書いた<br/>(past)"]
    A --> E["ない形<br/>書かない<br/>(negative)"]
    A --> F["可能形<br/>書ける<br/>(potential)"]
    A --> G["受身形<br/>書かれる<br/>(passive)"]
    A --> H["使役形<br/>書かせる<br/>(causative)"]
    A --> I["命令形<br/>書け<br/>(imperative)"]
    A --> J["条件形<br/>書けば<br/>(conditional)"]
    A --> K["意向形<br/>書こう<br/>(volitional)"]
    
    C --> L["て形 + いる<br/>書いている<br/>(progressive)"]
    D --> M["た形 + ことがある<br/>書いたことがある<br/>(experience)"]
    E --> N["ない形 + で<br/>書かないで<br/>(negative request)"]
    F --> O["可能形 + ない<br/>書けない<br/>(potential negative)"]
    ...
    style L fill:#FFEB3B,color:black
    style M fill:#CDDC39,color:black
    style N fill:#FF5722,color:white
