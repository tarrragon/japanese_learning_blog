...
敬語の適切性は、固定的な規則だけでなく、場面、関係性、コミュニケーションの目的など、様々な文脈要因に依存します。
...
The Japanese keigo system is one of the most developed systems of respectful language in the world. It has the following characteristics:
...
### Theoretical Issues of the Keigo System
...
### 實踐系統
- [敬語系統](../grammar/005_keigo_system.md) - 敬語的實際使用和規則

### 社會文化概念
- [內與外](007_uchi-soto.md) - 內外群體概念
- [視點理論](006_viewpoint.md) - 日語的視點概念

### 具體敬語形式
- [召し上がる・いただく](../honorific/001_meshiagaru_itadaku.md) - 敬語動詞範例
- [おっしゃる・申す](../honorific/002_ossharu_mousu.md) - 言說類敬語動詞
- [いらっしゃる・参る](../honorific/003_irassharu_mairu.md) - 移動類敬語動詞

### 文法模式
- [お〜になる](../grammar/025_o_go_ni_naru.md) - 尊敬語構成
- [お〜する](../grammar/026_o_go_suru.md) - 謙讓語構成

### 語言學理論
- [社會語言學](sociolinguistics.md) - 語言與社會的關係
- [語用學](pragmatics.md) - 語境中的語言使用
