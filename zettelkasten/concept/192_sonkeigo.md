...
flowchart TD
    ...
    C --> C1["行く → いらっしゃる<br/>（去 → 駕臨）"]
    C --> C2["言う → おっしゃる<br/>（說 → 說道）"]
...
flowchart TD
    ...
    B -->|"對方"| C["用尊敬語<br/>先生がいらっしゃる<br/>（老師駕臨）"]
    B -->|"我自己"| D["用謙讓語<br/>私が参ります<br/>（我前往）"]
    B -->|"我的上司<br/>（對外部人說）"| E["用謙讓語<br/>部長がおります<br/>（部長在）"]
    B -->|"我的上司<br/>（對內部人說）"| F["用尊敬語<br/>部長がいらっしゃいます<br/>（部長在）"]
