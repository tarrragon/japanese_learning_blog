...
```mermaid
flowchart TD
    A["尊敬語<br/>提高對方的動作或狀態"] --> B{"怎麼形成？"}

    B -->|"特殊動詞"| C["いらっしゃる<br/>來臨（來る→尊敬）"]
    B -->|"特殊動詞"| D["おっしゃる<br/>說（言う→尊敬）"]
    B -->|"加 れる/られる"| E["読まれる<br/>閱讀（讀む→尊敬）"]
    B -->|"お〜になる"| F["お読みになる<br/>閱讀（讀む→尊敬）"]
    B -->|"ご〜になる"| G["ご説明になる<br/>說明（說明する→尊敬）"]
...
- [謙讓語概念](kenjougo_concept.md) - 降低自己地位的敬語
- [丁寧語概念](teineigo_concept.md) - 基本禮貌表達

### 尊敬語文法形式
- [尊敬助動詞れる・られる](../grammar/sonkeigo_reru_rareru.md) - 助動詞形式
- [お〜になる](../grammar/o_ni_naru.md) - 和語尊敬構成
- [ご〜になる](../grammar/go_ni_naru.md) - 漢語尊敬構成

### 特殊尊敬動詞
- [いらっしゃる](../verb-u/irassharu.md) - 來・去・在的尊敬語
- [おっしゃる](../verb-u/ossharu.md) - 說的尊敬語
- [召し上がる](../verb-u/meshiagaru.md) - 吃・喝的尊敬語
- [なさる](../verb-u/nasaru.md) - 做的尊敬語
- [ご覧になる](../verb-u/goran_ni_naru.md) - 看的尊敬語

### 社會語言學概念
- [內與外](007_uchi-soto.md) - 內外群體概念對敬語的影響
- [視點理論](006_viewpoint.md) - 視點與敬語選擇的關係
- [社會階層](social_hierarchy.md) - 上下關係的語言表現
