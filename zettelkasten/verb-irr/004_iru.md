...
- 專門用於「有生命」的存在
- 是存在動詞中最基本、最常用的一個
- 與[ある](../verb-ru/013_aru.md)（待建立）形成對比（ある用於無生命）
...
| [ある](../verb-ru/013_aru\.md)（待建立） | 無生命（物品、抽象） | 本が**ある**（有書）|
...
- [進行形 vs 狀態形的區別](../grammar/017_progressive_vs_state.md)（待建立）

### Related Verbs
- [する - to do](001_suru.md) - Phase 1 Core Irregular Verb
- [来る - to come](002_kuru.md) - Phase 1 Core Irregular Verb
- [ある - to be/exist (inanimate)](../verb-ru/013_aru.md)（待建立） - Essential counterpart to いる
- [持つ - to hold/have](../verb-ru/014_motsu.md)（待建立） - Used in 持っている for possession
...
### Comparisons
- [いる vs ある 詳細比較](../comparison/012_iru_vs_aru.md)（待建立）
- [〜ている 的多重意義](../comparison/013_te_iru_meanings.md)（待建立）

### Honorifics
- [いらっしゃる・おる - いる的敬語](../honorific/007_irassharu_oru.md)（待建立）
