...
するの最も重要な特徴は、**名詞＋する**で新しい動詞を作れることです。これを「サ変動詞」（サ行変格活用動詞）と呼びます。
...
両方とも「する・やる」という意味ですが、ニュアンスが違います：

| 動詞 | ニュアンス | 使用場面 |
|------|-----------|---------|
| **する** | 中性的・フォーマル | 一般的、正式な場面 |
| **やる** | カジュアル・積極的 | 日常会話、仲間同士 |
...
するの可能形は特殊で、完全に別の動詞「できる」になります：

- 勉強する → 勉強**できる**（×勉強せられる）
- 料理する → 料理**できる**
- 運転する → 運転**できる**

**重要**：「〜することができる」という形も使えます：
- 勉強することができる（可以學習）
