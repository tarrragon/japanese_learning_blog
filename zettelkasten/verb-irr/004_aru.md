...
### 對比
- [[verb-irr/iru|いる]] - 有生命存在動詞（待建立）

### 相關文法
- [[particle/wa|は]] - 主題助詞
- [[particle/ga|が]] - 主語助詞
- [[particle/ni|に]] - 位置助詞
- [[grammar/te-aru|〜てある]] - 結果狀態文法（待建立）

### 相關概念
- [[concept/existence-verbs|存在動詞系統]] - 日文存在動詞的分類（待建立）
- [[concept/animate-inanimate|生命性分類]] - 有生命與無生命的語法區別（待建立）
...
### 相關動詞
- [[verb-irr/iru|いる]] - 有生命存在（待建立）
- [[verb-u/oku|置く]] - 放置
- [[verb-ru/sonzai-suru|存在する]] - 存在（正式用語）

### 相關概念
- [[concept/location-particles|位置助詞]] - に、で、へ的區別（待建立）
- [[grammar/existence-sentences|存在文]] - 存在句的完整語法（待建立）
