...
### 同義詞・類似概念
- [意味](018_imi.md) - 意思、含義（待建立）
- [伝える](../verb-u/伝える.md) - 傳達、告知（待建立）
- [コミュニケーション](コミュニケーション.md) - 溝通（待建立）
...
### 相關概念
- [表現の自由](../concept/表現の自由.md) - 表現自由（待建立）
- [非言語表現](../concept/非言語表現.md) - 非語言表達（待建立）
- [表現方法](../grammar/表現方法.md) - 表達方法（待建立）
