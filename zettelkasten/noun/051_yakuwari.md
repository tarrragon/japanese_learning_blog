...
### 相關動詞
- [果たす](../verb-u/果たす.md) - 履行、達成（待建立）
- [担う](../verb-u/担う.md) - 承擔、負責（待建立）
- [演じる](../verb-ru/演じる.md) - 扮演、演出（待建立）

### 相關表達
- [役割分担](役割分担.md) - 角色分工（待建立）
- [立場](立場.md) - 立場、處境（待建立）
- [当番](当番.md) - 值班、輪值（待建立）
