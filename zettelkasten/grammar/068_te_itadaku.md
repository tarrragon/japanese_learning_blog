...
type: grammar
jlpt: n3
tags: [grammar, giving-receiving, benefactive, te-form, humble]
related_grammar: [te_kureru, te_morau, te_ageru]
created: 2025-10-31
...
**文法類型**：補助動詞[^hojodoushi]、授受表現[^jujuhyougen]

## 日文解釋

「〜ていただく」は、他者が自分のために何かをしてくれることを表す謙讓表現[^kenjougo]です。「いただく」は「もらう」の謙讓語[^kenjougo]で、動作をしてくれる相手への敬意を示します。

基本構造：動詞て形[^te-form] + いただく

この表現は、相手が上位者[^jouisha]（目上の人、顧客、初対面の人など）である場合に使います。自分が利益を受ける立場を強調し、相手の行為に対して感謝と敬意を表します。

## 英文解釋

"〜te itadaku" is a humble expression[^kenjougo] that indicates someone does something for the speaker's benefit. "Itadaku" is the humble form[^kenjougo] of "morau" (to receive), showing respect to the person who performs the action.

Basic structure: verb te-form[^te-form] + itadaku

This expression is used when the other person is in a superior position[^jouisha] (e.g., someone older, a customer, someone you've just met). It emphasizes that the speaker is the beneficiary and expresses gratitude and respect for the other person's action.

## 中文解釋

「〜ていただく」是謙讓表現[^kenjougo]，表示他人為說話者做某事。「いただく」是「もらう」（得到）的謙讓語[^kenjougo]，對執行動作的對方表示敬意。

基本結構：動詞て形[^te-form] + いただく

當對方是上位者[^jouisha]（如長輩、客戶、初次見面的人等）時使用此表達。強調說話者是受益者的立場，對對方的行為表示感謝和敬意。
...
| 動詞分類 | て形 | ＋ いただく | 完整形式 |
|---------|------|-----------|---------|
| 一段動詞 | 教えて | いただく | 教えていただく |
| 五段動詞 | 書いて | いただく | 書いていただく |
| 不規則動詞 | 来て（きて） | いただく | 来ていただく |
| 不規則動詞 | して | いただく | していただく |
