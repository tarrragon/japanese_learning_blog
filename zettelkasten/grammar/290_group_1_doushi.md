---
title: "五段動詞（Group I 動詞）"
description: 以う段結尾的動詞群，日文最大的動詞類別
type: grammar
...
flowchart TD
    ...
    B -->|"いいえ<br/>（う・く・ぐ・す・つ・ぬ・ぶ・む）"| C["五段動詞<br/>（確定）"]
    B -->|"はい"| D{"語幹末尾は<br/>「い段」「え段」？"}

    D -->|"いいえ"| C
    D -->|"はい"| E["個別確認が必要<br/>（一段 or 五段）"]

    E --> F["一段動詞の可能性<br/>食べる・見る"]
    E --> G["五段動詞の例外<br/>帰る・入る・知る"]
```
