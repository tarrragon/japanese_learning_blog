---
title: "補助動詞"
description: 接在動詞て形後，添加語法意義的動詞群
type: grammar
jlpt: n3
stage: pending
tags:
...
flowchart TD
    ...
    style C1 fill:#81C784,color:black
    style C2 fill:#81C784,color:black
    style C3 fill:#81C784,color:black
    style C4 fill:#81C784,color:black
    style C5 fill:#81C784,color:black
    style D1 fill:#64B5F6,color:black
    style D2 fill:#64B5F6,color:black
    style D3 fill:#64B5F6,color:black
    style E1 fill:#FFB74D,color:black
    style E2 fill:#FFB74D,color:black
```
