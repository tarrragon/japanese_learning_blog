...
- [072 - 決定做某事（主動決定）](072_koto_ni_suru.md) 
- [073 - 表示動作完成後的結果狀態持續存在](073_te_aru.md) 
- [074 - 表示動作完了或帶有遺憾、後悔語氣的文法形式](074_te_shimau.md) 
- [075 - 持續狀態（已確認存在）](075_te_iru.md) 
- [076 - 表示事先準備或保持狀態的文法句型](076_te_oku.md) 
- [077 - 表示嘗試做某事的文法形式](077_te_miru.md) 
- [078 - 經驗表達（曾經做過某事）](078_ta_koto_ga_aru.md) 
- [079 - 〜た後で - 動詞た形接續的「之後」表達](079_ta_ato.md) 
- [080 - 表示動作剛剛完成，強調時間的接近性](080_ta_bakari.md) 
- [081 - 〜た時 - 表示「...的時候」的時間文法](081_ta_toki.md) 
- [082 - ました形は丁寧体における過去・完了の表現形式で、礼儀正しく過去の出来事を述べる際に使用します](082_mashita.md) 
- [083 - ます形的現在否定形式，用於禮貌地表達不做某事](083_masen.md) 
- [084 - ませんでした形是丁寧體的過去否定形式，用於禮貌地表達過去沒有做某事](084_masen_deshita.md) 
- [085 - 連體修飾的進階運用與實際應用](085_rentai_shushoku.md) 
- [086 - 表達打算、計劃或意圖的文法](086_tsumori_da.md) 
- [087 - する的可能形，表示能力或可能性](087_dekiru.md) 
- [088 - たら条件形，表示假定條件或時間順序](088_tara_jouken.md) 
- [089 - ば条件形 - 假定條件的進階用法與細節](089_ba_jouken.md) 
- [090 - と條件形（參照 052）](090_to_jouken.md) 
- [091 - 格助詞系統 - 日文中標記名詞文法功能的核心助詞體系](091_case_particles.md) 
- [092 - 他動詞與自動詞的完整解析 - 從概念到實踐的全方位指南](092_transitive_intransitive.md) 
- [093 - 自動詞與他動詞的對應關係及使用規則](093_jita_taiou.md) 
- [094 - 引用表達的文法模式](094_quotation_expression.md) 
- [095 - 並列助詞系統用於連接名詞、動詞、形容詞等句子成分，表達並列、列舉、添加等關係](095_conjunction_particles.md) 
- [096 - 存在表達 - ある/いる的基本句型與用法](096_aru_iru.md) 
- [097 - 移動動詞與を助詞的特殊用法：表示經過路徑、離開起點](097_movement_verbs.md) 
- [098 - 受身形的基本概念與應用](098_passive.md) 
- [099 - 使役形 - 表示讓某人做某事或給予許可的文法形式](099_causative.md) 
- [100 - 可能形 - 表達能力和可能性的動詞變化形式](100_potential.md) 
- [101 - 意向形（普通形）- 表達意志、建議和推測的動詞變化](101_volitional.md) 
- [102 - 命令形 - 日語動詞命令態](102_imperative.md) 
- [103 - 表示義務和必須性的文法句型](103_nakereba_naranai.md) 
- [104 - 最好...、應該...（建議的表達方式）](104_hou_ga_ii.md) 
- [105 - 表達理由和原因的文法模式](105_kara_node.md) 
- [106 - 〜ために - 表示「為了」（目的）或「因為」（原因）的文法](106_tame_ni.md) 
- [107 - 樣態助動詞「〜そうだ」，表示根據視覺觀察推測事物的狀態或即將發生的事](107_sou_da_appearance.md) 
- [108 - 傳聞表達「〜そうだ」- 表示從他人處聽說的資訊](108_sou_da_hearsay.md) 
- [109 - 表達「看起來...」的判斷文法](109_you_ni_mieru.md) 
- [110 - 表達推測、傳聞或典型特質的助動詞](110_rashii.md) 
- [111 - です形 - 名詞和形容詞的禮貌形式](111_desu_form.md) 
- [112 - れる・られる的尊敬語用法](112_rareru_honorific.md) 
- [113 - 日語基本句型（名詞句、形容詞句、動詞句）](113_basic_sentence_patterns.md) 
- [114 - 賓語（目的語）- 動作的直接對象](114_mokutekigo.md) 
- [115 - 列舉多個動作或狀態，表示「做...做...」](115_tari_tari.md) 
- [116 - 日文疑問詞系統的完整說明](116_question_words.md) 
- [117 - 丁寧な質問 - 禮貌提問的語法結構和使用方式](117_polite_questions.md) 
- [118 - 疑問助詞系統用於構成疑問句，包括か、の等助詞，表達疑問、確認、反問等語氣](118_question_particles.md) 
- [119 - 邀約文法 - 邀請他人、提出建議的各種表達方式](119_invitation_grammar.md) 
- [120 - 日語的語氣表達系統，用於表示說話者的態度、判斷和心理狀態](120_modal_expressions.md) 
- [121 - 否定系統整合 - 動詞、形容詞、名詞的否定表達完整體系](121_negation_system.md) 
- [122 - こと名詞化 - 動詞や形容詞を名詞化する基本文法](122_koto_nominalization.md) 
- [123 - 表達能力與可能性的基本句型](123_koto_ga_dekiru.md) 
- [124 - 表示決定或規定（非個人意志）](124_koto_ni_naru.md) 
- [125 - ましょう形（意向形丁寧體）- 動詞活用形式的基礎](125_mashou_kei.md) 
- [126 - 表示提議、建議或邀請的文法句型](126_mashou_ka.md) 
- [127 - 表示「做完...之後」的時間順序文法](127_te_kara.md) 
- [128 - 表示某動作或事件發生之前的時間點](128_mae_ni.md) 
- [129 - 表示在某動作或事件結束後進行另一個動作](129_ato_de.md) 
- [130 - 一邊...一邊...（表示同時進行兩個動作）](130_nagara.md) 
- [131 - 表示已確立的規定或慣例](131_koto_ni_natte_iru.md) 
- [132 - 〜ざるを得ない - 不得不、只好](132_zaruwoenai.md) 
- [133 - ](133_ni_naru.md) 
- [134 - ](134_te_ageru.md) 
- [135 - ](135_te_kudasaru.md) 
