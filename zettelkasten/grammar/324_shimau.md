...
```mermaid
flowchart TD
    A["〜てしまう<br/>補助動詞"] --> B{"語義功能"}

    B -->|"完成"| C["完了義<br/>・動作徹底完成<br/>・強調結果"]
    B -->|"遺憾"| D["遺憾義<br/>・不期望的結果<br/>・後悔・困擾"]
    B -->|"非本意"| E["不小心義<br/>・無意中做的<br/>・違背本意"]

    C --> F["例：本を読んでしまった<br/>（把書讀完了）"]
    D --> G["例：財布を落としてしまった<br/>（錢包掉了，糟糕）"]
    E --> H["例：つい食べてしまった<br/>（不小心吃了）"]
