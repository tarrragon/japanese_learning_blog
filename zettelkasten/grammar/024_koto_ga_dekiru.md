...
「ことができる」は日本語で能力や可能性を表現する基本的な文法パターンです。「〜することができる」という形で、「〜できる」「〜[が](../particle/001_ga.md)[^ga]可能だ」という意味を表します。

[^ga]: が（ga）は主語を示す格助詞。「ことができる」パターンの核心構成要素。

### 構成方式

**基本構造**: [動詞辞書形](010_dictionary_form.md)[^dict-form] + ことができる
...
| 不規則 | [する](../verb-irr/001_suru.md) | することができる | can do |
| 不規則 | [来る(くる)](../verb-irr/002_kuru.md) | 来ることができる | can come |
...
[^polite]: [ます形](007_masu_form.md)を使った丁寧な表現。ビジネスや目上の人との会話で必須。
...
### ことができる vs [可能形（られる形）](011_potential_form.md)[^potential]の比較
