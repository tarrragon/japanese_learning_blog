...
「てもいい」は日語中表達許可的基本句型，用於詢問或給予做某事的許可。這個句型由動詞的[て形](001_te_form.md)[^te-form]加上「もいい」組成，是日常會話中最常用的許可表達方式之一。

[^te-form]: て形は動詞の接続形。許可や依頼などの文型を作る基礎。

### 構成方式

**基本公式：** [動詞て形](001_te_form.md) + もいい
...
**否定形：** [動詞ない形](008_nai_form.md)[^nai-form] + くてもいい
...
### 「[〜てはいけない](024_tewa_ikenai.md)」との対比[^contrast]
...
| [〜てはいけない](024_tewa_ikenai.md) | 禁止（してはだめ） | ここで食べてはいけません。(You must not eat here.) |
