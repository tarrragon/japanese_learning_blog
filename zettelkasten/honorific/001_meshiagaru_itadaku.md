...
**動詞類型**：
- 召し上がる：五段動詞[^godan]（う動詞）
- いただく：五段動詞[^godan]（う動詞）

## 日文解釋

「召し上がる」と「いただく」は、「食べる」「飲む」の敬語形式[^keigo]です。

### 召し上がる（尊敬語[^sonkeigo]）

相手や目上の人[^meue]の「食べる」「飲む」動作を表現する尊敬語[^sonkeigo]です。相手の行為を高めることで敬意を示します。
...
**使用場面**：
- レストランやホテルでの接客[^kyakusetsu]
- 目上の人に食事を勧める時
- お客様への対応

### いただく（謙譲語[^kenjougo]）

自分が「食べる」「飲む」動作を表現する謙譲語[^kenjougo]です。自分の行為を低めることで、食べ物を提供してくれた相手や食べ物そのものへの感謝と敬意を示します。
...
**使用場面**：
- 食事を始める挨拶「いただきます[^itadakimasu]」
- 目上の人から食べ物をもらった時
- 丁寧に自分の食事行為を述べる時

### 普通体との違い

| 場面 | 普通体 | 尊敬語[^sonkeigo] | 謙讓語[^kenjougo] |
|------|--------|--------|--------|
| 相手の行為 | 食べる | 召し上がる | - |
| 自分の行為 | 食べる | - | いただく |
| 丁寧度 | 標準 | 高い | 高い |
...
"Meshiagaru" and "itadaku" are the honorific forms[^keigo] of "taberu" (to eat) and "nomu" (to drink).

**Meshiagaru (sonkeigo[^sonkeigo] - respectful language)**: This is used to refer to eating or drinking actions of someone you respect, such as customers, superiors[^meue], or guests. It elevates the other person's action to show respect. Commonly used in restaurants, hotels[^kyakusetsu], and when offering food to someone of higher status.

**Itadaku (kenjougo[^kenjougo] - humble language)**: This is used when talking about your own eating or drinking actions. It humbles your own action to show gratitude and respect toward the person who provided the food or the food itself. The phrase "itadakimasu[^itadakimasu]" (said before eating) is derived from this verb and expresses gratitude for the meal.
...
「召し上がる」和「いただく」是「食べる」（吃）和「飲む」（喝）的敬語形式[^keigo]。

**召し上がる（尊敬語[^sonkeigo]）**：用於指稱對方或尊長[^meue]的「吃」「喝」動作。通過提高對方的行為來表達敬意。常用於餐廳、飯店的接待[^kyakusetsu]，或向尊長推薦食物時。

**いただく（謙讓語[^kenjougo]）**：用於談論自己的「吃」「喝」動作。通過降低自己的行為，對提供食物的人或食物本身表達感謝和敬意。「いただきます[^itadakimasu]」（開動前說的話）就是從這個動詞衍生而來，表達對食物的感恩。
...
**例句1**
```
お客様、どうぞお[^o-honorific]召し上がりください[^kudasai]。
...
**召し上がる的注意點**：
- 只用於對方或第三者的動作，不能用於自己
- ❌ 私は朝ごはんを召し上がります（錯誤 - 用尊敬語於自己）
- ✅ 私は朝ごはんをいただきます（正確 - 用謙讓語於自己）

**いただくの注意點**：
- 只用於自己的動作，不能用於對方
- ❌ お客様はコーヒーをいただきますか（錯誤 - 用謙讓語於對方）
- ✅ お客様はコーヒーを召し上がりますか（正確 - 用尊敬語於對方）

### 其他相關敬語

- **お食べになる**[^o-ni-naru]：「食べる」的尊敬語形式（お〜になる）
- **お飲みになる**：「飲む」的尊敬語形式
- **頂戴する**：「いただく」的更謙遜形式

### 語域對照

| 語域[^register] | 表達方式 | 使用場合 |
|------|----------|----------|
| 粗俗[^vulgar] | 食う | 男性化、非正式 |
| 標準 | 食べる | 日常對話 |
| 禮貌 | 食べます | 一般禮貌場合 |
| 尊敬 | 召し上がる | 對方/尊長的動作 |
| 謙讓 | いただく | 自己的動作 |
...
[^o-honorific]: **美化接頭詞「お」** - 加在名詞或動詞前面，表示禮貌或美化。例：お茶、お召し上がりください

[^kudasai]: **〜ください請求文法** - 禮貌的請求或命令。與て形或名詞組合使用。例：召し上がってください

[^mashita-ka]: **過去疑問形「〜ましたか」** - 禮貌體的過去疑問句。ます形 + た + か
