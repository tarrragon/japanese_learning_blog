...
```mermaid
flowchart TD
    Start["用「したがって」還是「だから」？"] --> Q1{"是什麼場合？"}

    Q1 -->|"正式場合<br/>（報告、論文、演講）"| UseShitagatte1["使用「したがって」<br/><br/>調査の結果、改善が必要である。<br/>したがって、新しい対策を講じる。<br/><i>（調查結果顯示需要改善。<br/>因此，採取新對策。）</i>"]

    Q1 -->|"日常對話<br/>（朋友、家人）"| UseDakara1["使用「だから」<br/><br/>疲れたから、<br/>休憩しよう。<br/><i>（累了，所以休息吧。）</i>"]

    Q1 -->|"不確定"| Q2{"是客觀事實<br/>還是主觀判斷？"}

    Q2 -->|"客觀事實<br/>（數據、證據、<br/>邏輯推論）"| UseShitagatte2["使用「したがって」<br/><br/>条件を満たしている。<br/>したがって、合格である。<br/><i>（滿足條件。<br/>因此，合格。）</i>"]

    Q2 -->|"主觀判斷<br/>（個人意見、<br/>情感）"| UseDakara2["使用「だから」<br/><br/>彼は優しいから、<br/>信頼できる。<br/><i>（他很溫柔，<br/>所以可以信任。）</i>"]
    ...
    style UseShitagatte1 fill:#1976D2,color:white,stroke:#0D47A1,stroke-width:3px
    style UseShitagatte2 fill:#1976D2,color:white,stroke:#0D47A1,stroke-width:3px

    style UseDakara1 fill:#FF9800,color:white,stroke:#E65100,stroke-width:3px
    style UseDakara2 fill:#FF9800,color:white,stroke:#E65100,stroke-width:3px
```
