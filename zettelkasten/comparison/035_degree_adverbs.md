...
```mermaid
flowchart TD
    Start["選擇程度副詞"] --> Q1{"是正式書面語嗎？<br/>（論文、報告、演講）"}

    Q1 -->|"是"| UseHijō["使用「非常に」<br/><br/>この問題は<br/>非常に重要です<br/><i>（這問題極為重要）</i>"]

    Q1 -->|"否"| Q2{"是職場對話嗎？<br/>（對上司/客戶）"}

    Q2 -->|"是"| UseTotemo1["使用「とても」<br/>或「非常に」<br/><br/>とても良い結果です<br/><i>（很好的結果）</i>"]

    Q2 -->|"否"| Q3{"是親密朋友嗎？<br/>（年輕人之間）"}

    Q3 -->|"是"| Q4{"想表達強烈情緒？"}

    Q4 -->|"是"| UseMecha["使用「めちゃ」<br/>或「すごく」<br/><br/>めちゃうまい！<br/><i>（超好吃！）</i>"]

    Q4 -->|"否"| UseSugoku["使用「すごく」<br/>或「とても」<br/><br/>すごく楽しかった<br/><i>（很開心）</i>"]

    Q3 -->|"否"| UseTotemo2["使用「とても」<br/>（最安全）<br/><br/>とてもおいしいです<br/><i>（很好吃）</i>"]
    ...
    style UseHijō fill:#1565C0,color:white,stroke:#0D47A1,stroke-width:3px
    style UseTotemo1 fill:#43A047,color:white,stroke:#2E7D32,stroke-width:3px
    style UseTotemo2 fill:#43A047,color:white,stroke:#2E7D32,stroke-width:3px
    style UseSugoku fill:#FB8C00,color:white,stroke:#E65100,stroke-width:3px
    style UseMecha fill:#E53935,color:white,stroke:#B71C1C,stroke-width:3px
```
