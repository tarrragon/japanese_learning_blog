...
```mermaid
flowchart TD
    Start["選擇學習動詞"] --> Q1{"是學術研究嗎？"}

    Q1 -->|"是"| UseKenkyuu["使用「研究する」<br/><br/>大学で日本文学を<br/>研究しています<br/><i>（在大學研究日本文學）</i>"]

    Q1 -->|"否"| Q2{"是具體技能嗎？<br/>（樂器、運動、技藝）"}

    Q2 -->|"是"| Q3{"有老師指導嗎？"}

    Q3 -->|"是"| UseNarau["使用「習う」<br/><br/>ピアノを習っています<br/><i>（正在學鋼琴）</i>"]

    Q3 -->|"否"| UseBenkyou1["使用「勉強する」<br/><br/>独学でギターを<br/>勉強しています<br/><i>（自學吉他）</i>"]

    Q2 -->|"否"| Q4{"是從經驗學習嗎？"}

    Q4 -->|"是"| UseManabu["使用「学ぶ」<br/><br/>失敗から学びました<br/><i>（從失敗中學到）</i>"]

    Q4 -->|"否"| UseBenkyou2["使用「勉強する」<br/><br/>数学を勉強しています<br/><i>（正在學數學）</i>"]
    ...
    style UseKenkyuu fill:#9C27B0,color:white,stroke:#7B1FA2,stroke-width:3px
    style UseNarau fill:#4CAF50,color:white,stroke:#388E3C,stroke-width:3px
    style UseManabu fill:#FF9800,color:white,stroke:#F57C00,stroke-width:3px
    style UseBenkyou1 fill:#2196F3,color:white,stroke:#1976D2,stroke-width:3px
    style UseBenkyou2 fill:#2196F3,color:white,stroke:#1976D2,stroke-width:3px
```
