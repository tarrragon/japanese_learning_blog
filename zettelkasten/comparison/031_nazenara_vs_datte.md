...
```mermaid
flowchart TD
    Start["理由接續詞<br/>なぜなら or だって？"] --> Q1{"書面文還是<br/>口語對話？"}

    Q1 -->|"書面文"| UseNazenara1["使用「なぜなら」<br/><br/>この方法は効果的です。<br/>なぜなら、データが<br/>証明しているからです。<br/><i>（這方法有效，因為數據證明了）</i>"]

    Q1 -->|"口語對話"| Q2{"是否帶有<br/>辯解/抗議<br/>的語氣？"}

    Q2 -->|"是"| UseDatte1["使用「だって」<br/><br/>だって、時間が<br/>なかったんだもん<br/><i>（可是我沒時間啊！）</i>"]

    Q2 -->|"否"| Q3{"是否為正式<br/>或學術場合？"}

    Q3 -->|"是"| UseNazenara2["使用「なぜなら」<br/><br/>地球温暖化は深刻だ。<br/>なぜなら、気候変動が<br/>影響を与えているからだ<br/><i>（暖化很嚴重，因為影響氣候）</i>"]

    Q3 -->|"否"| Q4{"是否為<br/>主觀感受或<br/>個人理由？"}

    Q4 -->|"是"| UseDatte2["使用「だって」<br/><br/>だって、疲れてる<br/>んだもん<br/><i>（因為我累了啊）</i>"]

    Q4 -->|"否"| UseNazenara3["兩者皆可<br/>視語境選擇<br/><br/>正式用「なぜなら」<br/>隨意用「だって」"]
    ...
    style UseNazenara1 fill:#2196F3,color:white,stroke:#1976D2,stroke-width:3px
    style UseNazenara2 fill:#2196F3,color:white,stroke:#1976D2,stroke-width:3px
    style UseNazenara3 fill:#2196F3,color:white,stroke:#1976D2,stroke-width:3px

    style UseDatte1 fill:#FF9800,color:white,stroke:#F57C00,stroke-width:3px
    style UseDatte2 fill:#FF9800,color:white,stroke:#F57C00,stroke-width:3px
```
