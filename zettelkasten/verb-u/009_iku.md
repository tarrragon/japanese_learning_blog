...
auto_generated: true
needs_review: true
tags: [verb, basic, godan, movement, daily_life, irregular]
created: 2025-10-28
related_to: [[grammar/006_godan_verb]], [[grammar/001_te_form]], [[particle/004_de]]
---

## 日文
行く（いく）

ある場所から別の場所へ移動する最も基本的な[[grammar/006_godan_verb|五段動詞]]。N5レベルで最初に学ぶ重要な動詞で、日常会話で極めて頻繁に使用されます。[[grammar/001_te_form|て形]]が「行って」となる特殊な変化が特徴です。
...
- [[grammar/001_te_form|て形]] - て形（行く的特殊變化：行って）
...
### 相關文法
- [[grammar/007_masu_form|ます形]]（待建立） - 行きます的用法
- [[grammar/001_te_form|て形文法]] - 行って的用法（特殊：く→って）

### 相關動詞
- [[verb-u/008_aruku|歩く]] - 歩く（步行）
- [[verb-irr/002_kuru|来る]]（待建立） - 來（反向移動）
