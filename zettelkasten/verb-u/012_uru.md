...
tags:
  ...
  - basic
created: 2025-10-29
related_to: [006_godan_verb](../grammar/006_godan_verb.md), [002_wo](../particle/002_wo.md), [004_de](../particle/004_de.md), [007_ni](../particle/007_ni.md), [006_kau](006_kau.md)
---
## 日文
売る（うる）

商品やサービスを金銭と引き換えに提供する動作を表す基本的な[五段動詞](../grammar/006_godan_verb.md)。N5レベルで必ず学ぶ重要な動詞で、商業活動や日常生活で極めて頻繁に使用されます。「る」で終わる五段動詞の代表例であり、[買う](006_kau.md)の反義語として対で覚えることが重要です。
...
**注意点**：
- 可能形「売れる」は「売ることができる」だけでなく、「商品が売れる」（商品が購入される）という自動詞的な意味でも使われる
...
表示以金錢交換提供商品或服務的基本五段動詞。N5 級別必學的重要動詞，在商業活動和日常生活中使用極其頻繁。以「る」結尾的五段動詞代表例，作為[買う（買）](006_kau.md)的反義詞成對記憶很重要。
...
- [で](../particle/004_de.md) - で助詞（場所、手段、價格）
- [に](../particle/007_ni.md) - に助詞（方向、對象）
...
### 相關文法
- [ます形](../grammar/007_masu_form.md) - 売りますの用法
- [て形文法](../grammar/001_te_form.md) - 売っての用法（る→って）
