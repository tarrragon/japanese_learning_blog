...
基本的な五段動詞の一つ。言葉を使ってコミュニケーションする動作を表します。N5レベルで必ず学ぶ重要な動詞で、コミュニケーションに関する最も基本的な動詞です。五段動詞の「す」で終わる動詞の代表例として学習されます。
...
- [[verb-u/004_kaku|書く]] - 相關輸出技能動詞

### 相關助詞
- [[particle/002_wo|を]] - 話す的助詞（語言）

### 相關文法
- [[grammar/001_te_form|て形文法]] - 話して的用法
- [[grammar/007_masu_form|ます形]] - 話します的用法

### 相關動詞
- [[verb-u/005_kiku|聞く]] - 相關動詞（聽）
- [[verb-u/003_yomu|読む]] - 相關動詞（讀）
- [[verb-u/004_kaku|書く]] - 相關動詞（寫）
- （待建立）言う - 說（具體內容）
- （待建立）喋る - 聊天（口語）
