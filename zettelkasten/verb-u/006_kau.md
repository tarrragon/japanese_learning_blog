...
商品やサービスを金銭と交換して手に入れる動作を表す基本的な[[grammar/006_godan_verb|五段動詞]]。N5レベルで必ず学ぶ重要な動詞で、日常生活で極めて頻繁に使用されます。「う」で終わる五段動詞の代表例です。
...
- [[particle/004_de|で]] - で助詞（場所、手段）

### 相關文法
- [[grammar/007_masu_form|ます形]]（待建立） - 買います的用法
- [[grammar/001_te_form|て形文法]] - 買って的用法（う→って）

### 相關動詞
- [[verb-u/012_uru|売る]]（待建立） - 賣（反義詞）
