...
目的を持って外出する動作を表す一段動詞。「出る」と異なり、明確な目的地や用事があることを示します。N5レベルで学ぶ重要な動詞で、日常会話で頻繁に使用されます。
...
- [[grammar/004_mae_ni]] - ～前に（出かける前に）

### 相關動詞
- [[verb-ru/007_deru]] - 出る（單純離開）
- 行く - 去
- 来る - 來

### 相關助詞
- [[particle/003_kara]] - から助詞（起點）
- [[particle/004_de]] - で助詞（交通手段）
