...
auto_generated: true
needs_review: true
tags: [verb, basic, ichidan, daily_life, clothing]
created: 2025-10-28
...
衣服を身につける動作を表す基本的な一段動詞。N5レベルで必ず学ぶ重要な動詞で、日常生活で非常に頻繁に使用されます。上半身の衣服に使う動詞として「はく」「かぶる」と区別して覚える必要があります。
...
| Causative | 着させる | 子供に服を着させる (make child wear clothes) |
...
### 動詞基礎
- [[grammar/003_ichidan_verb]] - 一段動詞的完整說明
- [[verb-ru/001_taberu]] - 同類型一段動詞
